...
def Page(
    ...
    *,
    ...
    """Configure a page for ``st.navigation`` in a Pages app.
    ...
    title: str or None
        ...
        information, see `Overview of Pages apps
...
class StreamlitPage:
    """A page within a Pages Streamlit app.
